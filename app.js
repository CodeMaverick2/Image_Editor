...
function brightenFilter() {
	resetImage();
	brightnessSlider.value = 300;
	contrastSlider.value = 180;
	saturateSlider.value = 140;
	applyFilter();
}
...
function coolFilter() {
	...
	sepiaSlider.value = 40;
	brightnessSlider.value = Math.floor((Math.random() * 360) + 1);
	saturateSlider.value = 130;
	applyFilter();
}
